...
def test_read_csv_transactions_file_not_found():
    ...
    with patch("pandas.read_csv") as mock_read_csv:
        ...
        with pytest.raises(ValueError, match="Файл data/transactions.csv не найден"):
...
def test_read_excel_transactions_file_not_found():
    ...
    with patch("pandas.read_excel") as mock_read_excel:
        ...
        with pytest.raises(ValueError, match="Файл data/transactions_excel.xlsx не найден"):
            read_excel_transactions("data/transactions_excel.xlsx")


def test_read_excel_transactions_empty_file():
